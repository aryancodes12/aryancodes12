...
🛠 Love creating CLI tools, automation scripts, and data projects  
...
- Python (advanced concepts + clean architecture)
...
### 🔹 Modular CLI Task Manager
Persistent task manager with JSON storage, modular architecture & clean CLI UX

### 🔹 Data Analysis Projects
EDA, regression models, and visualizations using Python & R
